...
<head>
  ...
  <title>Dashboard &rsaquo; Profil &mdash; Warehouse BPBD | Kabupaten Jember</title>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="{{ route('staff.inlogistics.index')}}" class="nav-link"><i class="fas fa-sign-in-alt"></i> <span>Logistik
                  Masuk</span></a>
            </li>
            <li>
              <a href="{{ route('staff.outlogistics.index')}}" class="nav-link"><i class="fas fa-sign-out-alt"></i> <span>Logistik
                  Keluar</span></a>
            </li>
            <li class="menu-header">Pengaturan</li>
            <li class=active>
              <a href="{{ route('staff.profile.edit')}}" class="nav-link"><i class="fas fa-user"></i> <span>Profil</span></a>
            </li>
                ...
                <div class="card">
                  <form method="post" class="needs-validation" novalidate="">
                    ...
                    <div class="card-body">
                      ...
                      <div>
                        <form action="{{ route('staff.profile.updateBiography', $user->id) }}" method="POST">
                          @csrf
                          @method('PUT')
                          <div class="row">
