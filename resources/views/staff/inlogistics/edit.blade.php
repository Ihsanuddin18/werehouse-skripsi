...
<head>
    ...
    <title> Logistik Masuk &rsaquo; Edit logistik masuk &mdash; Warehouse BPBD | Kabupaten Jember</title>
                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item active"><a href="{{ route('staff.inlogistics.index') }}">Logistik Masuk</a>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="logisticForm" action="{{ route('staff.inlogistics.update', $inlogistic->id) }}"
                                ...
                                <div class="form-row">
                                    ...
                                    <div style="position: absolute; top: 0; right: 0;">
                                        <a href="{{ route('staff.inlogistics.index') }}" class="btn btn-primary mx-2"
