                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item"><a href="{{ route('staff.outlogistics.index') }}">Data Logistik Keluar</a>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="d-flex align-items-center justify-content-end">
                                    <a href="{{ route('staff.outlogistics.index') }}" class="btn btn-primary mr-2"
